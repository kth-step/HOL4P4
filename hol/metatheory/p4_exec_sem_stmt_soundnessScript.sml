...
Cases_on `stmt_stack` >> (
 ...
 metis_tac[(valOf o find_clause_stmt_red) "stmt_ret_e", clause_name_def, get_ectx_def],
...
Cases_on `is_v e` >> (
 ...
 Cases_on `stmt_stack` >| [
  metis_tac[(valOf o find_clause_stmt_red) "stmt_trans_e", clause_name_def, get_ectx_def],
...
rpt strip_tac >>
pairLib.PairCases_on `ctx` >>
rename1 `(ctx0, ext_map, func_map, b_func_map, pars_map, tbl_map, get_oracle_index, set_oracle_index, random_oracle)` >>
rename1 `(apply_table_f, ext_map, func_map, b_func_map, pars_map, tbl_map, get_oracle_index, set_oracle_index, random_oracle)` >>
Cases_on `status` >> (
 fs[stmt_exec_def]
) >>
...
Cases_on `index_not_const e_l` >> (
 ...
 Cases_on `stmt_stack` >| [
  ...
  fs[clause_name_def, get_ectx_def] >>
...
Cases_on `is_v e` >> (
 ...
 metis_tac[((valOf o find_clause_stmt_red) "stmt_ass_e"), clause_name_def, get_ectx_def]
 )
]
QED
...
Cases_on `is_v_bool e` >> (
 ...
 Cases_on `stmt_stack` >| [
  ...
  metis_tac[(valOf o find_clause_stmt_red) "stmt_cond_e", clause_name_def, get_ectx_def]
 )
]
QED
