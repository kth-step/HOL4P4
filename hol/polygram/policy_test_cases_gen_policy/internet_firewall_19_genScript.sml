...
val _ = new_theory "internet_firewall_19_gen";
...
val final_thm_res_eq_cake = fwd_proof_gen_eq_cake.gen_eq_policy_and_prove (arith_policy, policy_me, test_pd_type, policy_order, "internet_firewall_19_gen");
