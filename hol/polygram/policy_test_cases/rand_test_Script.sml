...
val policy_bdd_content_term = optionSyntax.dest_some (rhs (concl eval_policy_full_opt));


(* automatically generate a var table from the var policy's BDD via sml*)
val test_groupings = rhs(concl(EVAL policy_full_order));
val gen_var_table_auto =  bdd_to_tables_iterative policy_bdd_content_term test_groupings;
...
val table_bdd_content_term = optionSyntax.dest_some (rhs (concl eval_table_full_opt_auto));
...
val var_eq_thm_extract_red = computeLib.RESTR_EVAL_RULE
                                       [“correct_var_policy_var_tables_exec”, “sem_tables”,“sem_policy”, “mv_dom_vars”,
                                        “isIsomorph_exec”, “node_in_BDD”, “prop_in_BDD”, “ALL_DISTINCT”, “fv_in_vars_exec”
                                       ]  var_eq_thm_extract;

(*
val term = concl var_eq_thm_extract_red ;



val var_policy_var_table_thm = SIMP_RULE bool_ss [correct_var_policy_var_tables_exec_thm1,
                                                  assumption1, assumption2,
                                                  assumption3, assumption4, assumption5, assumption6,
                                                  assumption7, assumption8, assumption9,
                                                  isIsomorph_exec_thm] var_eq_thm_extract_red;  *)

REWRITE_RULE [] (ASM_REWRITE_RULE  [correct_var_policy_var_tables_exec_thm1,
                                                  assumption1, assumption2,
                                                  assumption3, assumption4, assumption5, assumption6,
                                                  assumption7, assumption8, assumption9,
                                                  isIsomorph_exec_thm] (var_eq_thm_extract_red ))

PURE_REWRITE_CONV [correct_var_policy_var_tables_exec_thm1,
                                                  assumption1, assumption2,
                                                  assumption3, assumption4, assumption5, assumption6,
                                                  assumption7, assumption8, assumption9,
                                                  isIsomorph_exec_thm] (concl var_eq_thm_extract_red)
...
val var_policy = “[(And (Var "LAN1_max") (And (Var "LAN1_min")
(Or ( And (Var "tcp_443_min") (Var "tcp_443_max") )
     (And (Var "tcp_22_min") (Var "tcp_22_max")) )), action ("fwd",[1]));

 (And (Var "LAN2_max") (And (Var "LAN2_min")
 ( And (Var "tcp_443_min") (Var "tcp_443_max") )
     ),action ("fwd",[2]));


 (And (Var "LAN2_max") (And (Var "LAN2_min")
 ( And (Var "tcp_22_min") ( And (Var "tcp_22_max") (Var "ttl_10") ) )
     ),action ("fwd",[3]));
...
val policy_order = “[
                     ...
                     "tcp_443_min"; "tcp_443_max";
                     "tcp_22_min";"tcp_22_max";
...
(Or ( And (Var "tcp_443_min") (Var "tcp_443_max") )
 ...
 (And (Var "LAN2_max") (And (Var "LAN2_min") (Var "ttl_10")
     ),action ("fwd",[3]));
...
val policy_order = “["LAN1_max";"LAN1_min";
                     "LAN2_max";"LAN2_min";
                     "tcp_443_min"; "tcp_443_max";
                     "tcp_22_min";"tcp_22_max";
                     "ttl_10"]”;
...
val var_policy = “[
 ...
 (And (Var "LAN2_max") (And (Var "LAN2_min")
                            (Or ( And (Var "tcp_443_min") (Var "tcp_443_max") )
                                 (And (Var "tcp_22_min") (Var "tcp_22_max")) )), action ("fwd",[2]));


 (And (Var "LAN2_max") (And (Var "LAN2_min")
                                 (Var "ttl_10") ) ,action ("fwd",[3]));


 (And (Var "LAN2_max") (And (Var "LAN2_min")
                            ( And (Var "tcp_22_min") (Var "tcp_22_max") )),action ("fwd",[4]));



 (And (Var "LAN1_max") (And (Var "LAN1_min")
                            (Or ( And (Var "tcp_443_min") (Var "tcp_443_max") )
                                (And (Var "tcp_22_min") (Var "tcp_22_max")) )), action ("fwd",[1]));
...
val policy_order = “["LAN2_max";"LAN2_min";
                       "LAN1_max";"LAN1_min";
...
val LAN1_x = “(And (Var "LAN1_max") (Var "LAN1_min"))”;
val LAN2_x = “(And (Var "LAN2_max") (Var "LAN2_min"))”;
...
val var_policy = “[
  ...
  (And (Var "tcp_srv") ^LAN1_x ,
   action ("fwd",[1]));

  (And (Var "tcp_dyn") (Or ^LAN1_x ^LAN2_x), action ("fwd",[2]));

  (And (Var "tcp_dyn") (And (Not (Or ^LAN1_x ^LAN2_x)) (Var "ttl_ge_1")),
   action ("fwd",[3]));

  (And (Var "tcp_srv") (Or ^LAN1_x ^LAN2_x),
   action ("fwd",[4]));
...
val policy_bdd = optionSyntax.dest_some (rhs(concl (EVAL “mk_BDDPred_opt policy_structure (0,[],[(0, non_termn (NONE, ^var_policy))]) [] ^policy_order 1 ”)));

val grp_test = “[
                   ("ip_address" ,["LAN1_max";"LAN1_min";
                                   "LAN2_max";"LAN2_min";]);
                   ("tcp" ,["tcp_srv"; "tcp_dyn"]);
                   ("ttl" ,["ttl_ge_1"])
                 ]”;
...
val gen_var_table_auto = bdd_utilsLib.bdd_to_tables_iterative policy_bdd grp_test;


val eval_table_full_opt_auto = EVAL “mk_BDDPred_opt table_structure
              (0,[],[(0, non_termn (NONE, ^gen_var_table_auto))]) [] ^policy_order 1”;


val test_pd_type = “[("h", type_record [
                                         ("ttl", type_length 8);
                                         ("ip_dest", type_length 32);
                                         ("tcp_dest", type_length 16)])]”;
...
val LAN1_max = “(arithm_le (lv_acc (lv_x "h") "ip_dest") ^(bdd_utilsLib.make_bv (167772415) 32))”;
val LAN1_min = “(arithm_ge (lv_acc (lv_x "h") "ip_dest") ^(bdd_utilsLib.make_bv (167772160) 32))”;


val LAN2_max = “(arithm_le (lv_acc (lv_x "h") "ip_dest") ^(bdd_utilsLib.make_bv (3232296959) 32))”;
val LAN2_min = “(arithm_ge (lv_acc (lv_x "h") "ip_dest") ^(bdd_utilsLib.make_bv (3232235520) 32))”;


val tcp_srv   = “(arithm_le (lv_acc (lv_x "h") "tcp_dest") ^(bdd_utilsLib.make_bv (1203) 16))”;
val tcp_dyn = “(arithm_ge (lv_acc (lv_x "h") "tcp_dest") ^(bdd_utilsLib.make_bv (49150) 16))”;


val ttl_ge_1 = “(arithm_ge (lv_acc (lv_x "h") "ttl") ^(bdd_utilsLib.make_bv 1 8))”;





val policy_me =   “[("LAN2_max", ^LAN2_max);
                    ("LAN2_min", ^LAN2_min);
                    ("LAN1_max", ^LAN1_max);
                    ("LAN1_min", ^LAN1_min);
                    ("tcp_srv", ^tcp_srv);
