...
val _ = new_theory "internet_firewall_40_simple";
(*
...
val policy_eq_thm = fwd_proof_polcies_cakeLib.check_two_polcies_eq (arith_policy1, arith_policy2, policy_me, test_pd_type, policy_order, "internet_firewall_40_simple_");
