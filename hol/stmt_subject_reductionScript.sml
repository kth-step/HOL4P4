...
val bit_slice_typed_lemma = prove ( “
∀ p p' w bitv bitv' x.                                   
...
gvs[] >>
    ...
    IMP_RES_TAC bit_slice_typed_lemma  >> gvs[]
,
...
Proof
cheat (* same proof as fr_len_from_a_frame_theorem*)
QED
...
val empty_frame_not_typed = prove ( “
...
val frame_typ_head_of_stmtl = prove (
 “
