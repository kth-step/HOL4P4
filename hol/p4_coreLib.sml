...
val core_packet_in_map =
 ``(FEMPTY |+ ("extract", (stmt_seq (stmt_ext packet_in_extract) (stmt_ret (e_v v_bot)), [("this", d_inout); ("hdr", d_out)]))):ext_fun_map``;

val core_packet_out_map =
 ``(FEMPTY |+ ("emit", (stmt_seq (stmt_ext packet_out_emit) (stmt_ret (e_v v_bot)), [("this", d_inout); ("data", d_in)]))):ext_fun_map``;
