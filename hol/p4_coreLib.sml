...
val core_header_map =
 ``(FEMPTY
    |+ ("isValid", (stmt_seq stmt_ext (stmt_ret (e_var varn_ext_ret)), [("this", d_inout)], header_is_valid))):ext_fun_map``;

val core_packet_in_map =
 ``(FEMPTY |+ ("extract", (stmt_seq stmt_ext (stmt_ret (e_v v_bot)), [("this", d_inout); ("hdr", d_out)], packet_in_extract))):ext_fun_map``;

val core_packet_out_map =
 ``(FEMPTY |+ ("emit", (stmt_seq stmt_ext (stmt_ret (e_v v_bot)), [("this", d_inout); ("data", d_in)], packet_out_emit))):ext_fun_map``;
