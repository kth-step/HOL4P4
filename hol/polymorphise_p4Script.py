...
od_hacks = OrderedDict([("val _ = type_abbrev(\"ascope\", ``:('a)``);", ""), #Delete this type abbreviation
                        ...
                        ("val _ = type_abbrev(\"ext_fun_map\", ``:(string |-> (stmt # (string # d) list # ext_fun))``);",
                         "val _ = type_abbrev(\"ext_fun_map\", ``:(string |-> (stmt # (string # d) list # 'a ext_fun))``);"),
                        ("val _ = type_abbrev(\"ext_map\", ``:(string |-> (((stmt # (string # d) list # ext_fun) option) # ext_fun_map))``);",
                         "val _ = type_abbrev(\"ext_map\", ``:(string |-> (((stmt # (string # d) list # 'a ext_fun) option) # 'a ext_fun_map))``);"),
