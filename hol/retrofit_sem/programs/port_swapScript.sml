...
open p4_exec_arch_v1modelProgTheory;
...
val port_swap_actx = “([arch_block_inp;
  arch_block_pbl "p"
...
val port_swap_astate = “((0,[],[],0,[],[("parseError",v_bit (fixwidth 32 (n2v 0),32))],[]),
...
val res = dest_some $ rhs $ concl $ EVAL “arch_multi_exec ^actx (p4_append_input_list [^input] ^astate) 43”
...
val actx = port_swap_actx;
val astate = port_swap_astate;
val n_max = “1000:num”;
...
val res = dest_some $ rhs $ concl $ EVAL “cake_top_exec ^input”
