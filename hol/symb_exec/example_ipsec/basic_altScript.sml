...
(* IPsec example
 * Mid-size example based on https://github.com/didriklundberg/p4-ipsec
 * (a fork of the code from this paper: https://arxiv.org/abs/1907.03593)
 *
 * This version has also undergone a program transformation that moves the
 * evaluation of the in-directed data argument of checksum computation
 * before the method call.
 *
 * Below is automatically generated by input tool: *)
...
(* Setting up the input packet. Note that this implicitly assumes the input has a certain length *)
...
(* Well-formedness assumptions on table content for the precondition *)
...
(* The arguments to symbolic execution are mapped to variables here to enable easier debugging *)
...
(* Defining the postcondition *)
(* Pick the bits at the right positions according to the input packet definition above *)
