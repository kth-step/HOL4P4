...
The list of statement $\stmtL$ is simply a list of $stmt_1 \cons stmt_n$ where $stmt_1$ belongs to the most recent block we have entered, and $stmt_n$ is the oldest one.
...
Note that the statement semantics operates on single frames. 
